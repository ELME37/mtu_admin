...
import {Root, Container, Title} from './index.styled'

function TestA(){
    return (
        <StyledSidebar >
        <Link to={ROUTES.home} className="sidebar__logo">
            <Logo/>
        </Link>
        ...
        <SidebarContainer className='sidebar__container'>
            <ul className="sidebar__list">
                <li className='sidebar__list--item'>
                    <NavLink to={ROUTES.collaborateurs} className="sidebar__item--link">
                ...
                <li className='sidebar__list--item'>
                    <NavLink to={ROUTES.planning} className="sidebar__item--link">
                    <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="20" height="20"><path d="M19,2H18V1a1,1,0,0,0-2,0V2H8V1A1,1,0,0,0,6,1V2H5A5.006,5.006,0,0,0,0,7V19a5.006,5.006,0,0,0,5,5H19a5.006,5.006,0,0,0,5-5V7A5.006,5.006,0,0,0,19,2ZM2,7A3,3,0,0,1,5,4H19a3,3,0,0,1,3,3V8H2ZM19,22H5a3,3,0,0,1-3-3V10H22v9A3,3,0,0,1,19,22Z"/><circle cx="12" cy="15" r="1.5"/><circle cx="7" cy="15" r="1.5"/><circle cx="17" cy="15" r="1.5"/></svg>
                        <span>Planning</span>
                    </NavLink>
                </li>
                <li className='sidebar__list--item'>
                    <NavLink to={ROUTES.entretien} className="sidebar__item--link">
                ...
                <li className='sidebar__list--item'>
                <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="20" height="20"><path d="M12,0A12,12,0,1,0,24,12,12.013,12.013,0,0,0,12,0Zm0,22A10,10,0,1,1,22,12,10.011,10.011,0,0,1,12,22Z"/><path d="M12,6a1,1,0,0,0-1,1v4.325L7.629,13.437a1,1,0,0,0,1.062,1.7l3.84-2.4A1,1,0,0,0,13,11.879V7A1,1,0,0,0,12,6Z"/></svg>
                    <Dropdown buttonText="Historique" trigger="click" links={[
                        { href: '#', label: 'Campagne 2023' },
                        { href: '#', label: 'Campagne 2022' },
                        { href: '#', label: 'Campagne 2022' },
                        { href: '#', label: 'Campagne 2021' },
            ]}  />
                ...
                <li className='sidebar__list--item'>
                    <NavLink to={ROUTES.reporting} className="sidebar__item--link">
                    <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="20" height="20"><path d="M23,22H3a1,1,0,0,1-1-1V1A1,1,0,0,0,0,1V21a3,3,0,0,0,3,3H23a1,1,0,0,0,0-2Z"/><path d="M15,20a1,1,0,0,0,1-1V12a1,1,0,0,0-2,0v7A1,1,0,0,0,15,20Z"/><path d="M7,20a1,1,0,0,0,1-1V12a1,1,0,0,0-2,0v7A1,1,0,0,0,7,20Z"/><path d="M19,20a1,1,0,0,0,1-1V7a1,1,0,0,0-2,0V19A1,1,0,0,0,19,20Z"/><path d="M11,20a1,1,0,0,0,1-1V7a1,1,0,0,0-2,0V19A1,1,0,0,0,11,20Z"/></svg>
                        <span>Reporting</span>
                    </NavLink>
                </li>
            </ul>
